...
def write_reg(ListOfRegs,Read):
    ...
    for register in ListOfRegs:
        ...
        if ChangePage:
            command = "i2cwr 0x77 0x01 1 "+register[0][0:4]+""
            if Read:
                print(get_command(command))
            else:
                get_command(command)
        command = "i2cwr 0x77 0x"+register[0][4:6]+" 1 "+register[1]+""
        if Read:
            print(get_command(command))
        else:
            get_command(command)
    ...
    if Read:
        ...
        get_command("i2cwr 0x77 0x01 1 0")
...
print(get_command("i2cwr 0x20 0x07 1 0"))
...
print(get_command("i2cwr 0x20 0x03 1 13"))
print(get_command("i2cwr 0x20 0x03 1 1b"))
